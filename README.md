...
- **Stylish web design**
- **Responsiveness for phone and desktop screens**
- **Dinamic information**
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/danifromecuador/conference
  ```
...
If you like this project let me know sharing [my Portfolio](https://github.com/danifromecuador) with recruiters!
